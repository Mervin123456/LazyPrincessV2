...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/moviesarenarequest"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/moviesarenareq')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@trendtrackertoday?si=9lT15pFca4jka_7p')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
